  ...
  const option = (value: 'light' | 'dark', Icon: typeof Sun, label: string) => {
    ...
    return (
      <button
        ...
        aria-pressed={active}
        title={`${label} theme`}
        className={`flex flex-1 items-center justify-center gap-1.5 rounded-md px-2 py-1.5 text-xs font-medium transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ops-600 ${
