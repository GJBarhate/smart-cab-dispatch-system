...
export function Aurora() {
  return <div className="er-aurora" aria-hidden="true">
...
export function TiltCard({
  ...
  return <div className="er-tilt-scene">
      <div ref={ref} className={`er-tilt relative ${className}`} onPointerMove={onPointerMove} onPointerLeave={onPointerLeave}>
        {children}
