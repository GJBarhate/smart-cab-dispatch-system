...
export const Button = forwardRef(({
  ...
  children,
  ...rest
}, ref) => <button ref={ref} disabled={disabled || loading} className={`inline-flex items-center justify-center gap-2 rounded-md font-medium transition-[background,transform,box-shadow,border-color] duration-150 disabled:cursor-not-allowed disabled:opacity-50 disabled:active:transform-none ${VARIANTS[variant]} ${SIZES[size]} ${className}`} {...rest}>
