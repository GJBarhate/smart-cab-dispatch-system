...
export const DRIVER_STATUS_COLOR: Record<DriverStatus, string> = {
  idle: '#059669', // emerald — available
  assigned: '#2563eb', // blue — offered/accepted, not moving
  en_route_pickup: '#2563eb',
  at_pickup: '#d97706', // amber
  on_trip: '#7c3aed', // ops purple — guest aboard
  on_break: '#6b7280', // gray
  offline: '#9ca3af',
...
export function carDivIcon(status: DriverStatus, heading = 0): L.DivIcon {
...
export function pinDivIcon(color: string, pulse = false): L.DivIcon {
