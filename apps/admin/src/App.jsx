...
function WarmupSplash({
  ...
  useEffect(() => {
    ...
    apiClient.get('/health').catch(() => null).finally(() => {
      if (cancelled) return;
  ...
  if (!ready && waking) {
    return <div className="flex min-h-screen flex-col items-center justify-center gap-3 bg-ops-50 text-center">
...
function RouteFallback() {
  return <div className="flex min-h-[60vh] items-center justify-center" role="status" aria-label="Loading page">
