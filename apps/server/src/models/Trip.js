...
const stopSchema = new _mongoose.Schema({
  seq: {
    type: Number,
    required: true
  },
...
const tripSchema = new _mongoose.Schema({
  ...
  status: {
    type: String,
    enum: ['pending_driver', 'accepted', 'en_route_pickup', 'at_pickup', 'boarded', 'completed', 'cancelled', 'rejected', 'unassignable'],
...
const Trip = (0, _shared.getModel)('Trip', tripSchema);
exports.Trip = Trip;
