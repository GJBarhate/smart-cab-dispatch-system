...
export function InstallPrompt() {
  ...
  return <Card className="relative mb-4 border border-brand-100 bg-brand-50">
      ...
      <div className="flex items-start gap-3 pr-4">
        ...
        <div className="flex-1">
          ...
          {deferred ? <>
              ...
              <Button className="mt-2 min-h-[36px] px-4 py-1 text-sm" loading={installing} onClick={async () => {
            setInstalling(true);
            try {
