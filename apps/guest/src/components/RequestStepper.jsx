  ...
  return <Card>
      ...
      <ol className="mt-4 space-y-3">
        ...
        return <li key={label} className="flex items-center gap-3">
              <span className={`flex h-3 w-3 flex-shrink-0 items-center justify-center rounded-full ${done ? 'bg-brand-600' : active ? 'bg-brand-400 ring-4 ring-brand-100' : 'bg-line'}`} />
