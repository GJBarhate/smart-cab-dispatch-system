...
export default function Login(): JSX.Element {
  ...
  return (
    <div className="relative flex h-full flex-col justify-center overflow-hidden bg-canvas px-6 py-10">
      <Aurora />
          ...
          <form onSubmit={handleSubmit} className="er-glass space-y-4 rounded-2xl p-5">
            <div>
              ...
              <input
                ...
                className="min-h-[52px] w-full rounded-xl border border-line bg-surface/80 px-4 text-lg font-semibold uppercase tracking-wide text-ink outline-none focus:border-brand-500 focus:ring-2 focus:ring-brand-100"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="min-h-[52px] w-full rounded-xl border border-line bg-surface/80 px-4 text-lg text-ink outline-none focus:border-brand-500 focus:ring-2 focus:ring-brand-100"
              />
            </div>
