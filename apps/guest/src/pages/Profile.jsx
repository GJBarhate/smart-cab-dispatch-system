  ...
  return <div className="space-y-4 p-4 pb-6">
      ...
      <Card>
        ...
        <div className="mt-4 space-y-2 text-sm">
          ...
          {guest.accommodationId && <div className="flex items-center gap-2 text-muted">
      ...
      <Card>
        <div className="flex items-center justify-between">
          ...
          {permission === 'default' && <Button variant="secondary" className="min-h-[36px] px-3 py-1 text-sm" onClick={request}>
              Enable
            </Button>}
        </div>
      </Card>
      ...
      <ConfirmDialog open={logoutOpen} title="Log out?" message="You'll need to sign in again with your booking ref and phone number." confirmLabel="Log out" danger loading={loggingOut} onConfirm={handleLogout} onCancel={() => setLogoutOpen(false)} />
    </div>;
}
