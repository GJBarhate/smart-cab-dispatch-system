...
export const toLeafletTuple = p => [p.lat, p.lng];
export const geoPointToLeaflet = g => {
  const ll = toLatLng(g);
...
export function decodePolylineToLeaflet(str, precision = 5) {
  if (!str) return [];
